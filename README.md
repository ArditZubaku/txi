...
- **Cursor line highlight** — the line the cursor is on is drawn as a light gray band across the full width of the terminal, gutter included, like VIM's `cursorline`.
